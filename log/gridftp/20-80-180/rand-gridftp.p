data = "rand-gridftp.dat"
figure = "rand-gridftp.emf"
...
data using 7:($0+1) title 'N1' with linespoints lc rgb "black", \
data using 8:($0+1) title 'N5' with linespoints lc rgb "black", \
data using 9:($0+1) title 'N10' with linespoints lc rgb "black", \
data using 10:($0+1) title 'N30' with linespoints lc rgb "black"
