...
plot data using 1:($0+1) title '1VM' with linespoints lc rgb "black", \
data using 2:($0+1) title '5VMs' with linespoints lc rgb "black", \
data using 3:($0+1) title '10VMs' with linespoints lc rgb "black", \
data using 4:($0+1) title '30VMs' with linespoints lc rgb "black"
